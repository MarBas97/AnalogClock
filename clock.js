...
class Clock {
    constructor(canvas, clockRadius) {
        ...
        this.indicators.push(new Indicator(this.ctx, 1.5, 'black', this.clockRadius * 0.9, Date.now(), 's'), new Indicator(this.ctx, 2.75, 'black', this.clockRadius * 0.75, Date.now(), 'm'), new Indicator(this.ctx, 5, 'blue', this.clockRadius * 0.55, Date.now(), 'h'));
    }
    buildFace() {
        this.clockFace.draw();
